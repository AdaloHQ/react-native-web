...
var CellRenderer = function (_React$Component) {
  ...
  CellRenderer.prototype.render = function render() {
    ...
    var cellStyle = inversionStyle ? horizontal ? [styles.rowReverse, inversionStyle, style] : [styles.columnReverse, inversionStyle, style] : horizontal ? [styles.row, inversionStyle, style] : [inversionStyle, style];
